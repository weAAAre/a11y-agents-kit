...
- **[Guidepup](https://www.guidepup.dev/)** — VoiceOver and screen reader automation library by Craig Morten, used under the [MIT License](https://github.com/guidepup/guidepup/blob/main/LICENSE).
